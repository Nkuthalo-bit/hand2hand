...
if($row['email']==$email)
{
  ...
  echo '<script type="text/javascript">alert("Email Account exist Please login"); window.location = "loginShipper.php";</script>';
...
$sql="insert into shipper(surname,name,id_number,gender,phone_number,email,password,account_status)
       ...
       echo '<script type="text/javascript">alert("You Succesfully Registered Please Login Your Account"); window.location = "loginShipper.php";</script>';
