...
<nav class="navbar navbar-light navbar-expand-md navigation-clean" style="background-color: rgb(0,16,33);">
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form action="newshipperpass.php" class="custom-form" name="form" onsubmit="return validateForm();" method="post">

                <h2>Update Password as a Shippper</h2>
                <br>
                <br>
               ...
               <div class="form-row form-group">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input name="cellno" id="cellno" class="form-control" type="text"><span id="cerror"></span></div>
                </div>
                
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="pawssword-input-field">Create New Password </label></div>
