...
cerrormessage.innerHTML=""
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" action="shipperreg.php" name="form" onsubmit="return validateForm();" method="post">
                <h2>Shipper Register Form</h2>
                <br><br>
                ...
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Male&nbsp;</label>
                    <input type="radio" name="gender" value="Male" checked required><br>
                    <label class="col-form-label" for="name-input-field">Female&nbsp;</label>
                    <input type="radio" name="gender" value="Female" required><br>
                    <label class="col-form-label" for="name-input-field">Other&nbsp;</label>
