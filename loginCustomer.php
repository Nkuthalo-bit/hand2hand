...
<nav class="navbar navbar-light navbar-expand-md navigation-clean" style="background-color: rgb(0,16,33);">
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
                ...
                <form class="custom-form" style="color: rgb(0,16,33);"" action="customerlog.php" name="form" onsubmit="return validateForm();" method="post">
                ...
                </div><input type="submit" class="btn btn-light submit-button" style="background-color: rgb(0,16,33);" value="Login"><a style="color: rgb(0,16,33);" href="recovercustomerpass.php">forgot password?</a></form>
        </div>
    </div>
