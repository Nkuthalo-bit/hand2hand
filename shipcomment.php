...
$command="insert into complaints (shipper_id,message)
values ('$id','$name')";
...
echo '<script>alert(" complain sent.");window.location = "shipperprofile.php";</script>';
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form action="" class="custom-form" name="form" onsubmit="return validateForm();" method="post">
                ...
                <a href="shipperprofile.php" ><input type="button" style="background-color: rgb(0,16,33);" class="btn btn-light submit-button" value="Exit"></a>
