...
<nav class="navbar navbar-light navbar-expand-md navigation-clean" style="background-color: rgb(0,16,33);">
    ...
    <div class="row register-form">
        ...
        <div class="col-md-8 offset-md-2">
                ...
                <form class="custom-form" style="color: rgb(100,109,230);" action="shipperlog.php" name="form" onsubmit="return validateForm();" method="post">
                 <h2 style="color:rgb(0,16,33);">Shipper Login</h2>
                ...
                </div><input type="submit" class="btn btn-light submit-button" value="Login" style="background-color: rgb(0,16,33);"><a style="color: rgb(0,16,33);" href="recovershipperpass.php">forgot password?</a></form>
        </div>
    </div>
