...
<br><br>
    ...
    <input type="submit" placeholder="Search Here" value="search" class="btn btn-light submit-button" type="button" style="background-color: rgb(0,16,33);color :white;" style="height:35px;"></input>&nbsp;
...
<br><br>
<form class="custom-form" style="color: rgb(100,109,230);">
    ...
    <div class="col text-justify" style="font-size: 12px;">
              ...
              ?>
                <tbody>
                    <tr style="font-size: 12px;">
                        ...
                        <td><a style="color: white;" href="<?php echo $rows['link'];?>"><?php echo $rows['pickup'];?></a></td>
