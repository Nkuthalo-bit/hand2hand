...
echo '<script>alert("Information Updated.");window.location = "customer prev.php";</script>';
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form action="" class="custom-form" name="form" onsubmit="return validateForm();" method="post">
                ...
                <h2 style="bcolor: rgb(0,16,33);">&nbsp;Update customer Details</h2>
                <br><br>
                ...
                <a href="customer prev.php" ><input type="button" style="background-color: rgb(0,16,33);" class="btn btn-light submit-button" value="Cancel"></a>
