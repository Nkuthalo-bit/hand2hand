...
$qry=mysqli_query($connect,"select customer.surname as surname,customer.name as name,customer.id_number as idno ,customer.email as email,customer.gender as gender,customer.phone_number as cellno from customer 
...
$command="UPDATE  customer SET surname='$surname',name='$name',id_number='$idno',email='$email',phone_number='$cellno'
WHERE customer.email='$email'";
...
echo '<script>alert("Information Updated.");window.location = "custprofile.php";</script>';
        ...
        <div class="col-md-8 offset-md-2">
            <form action="" class="custom-form" name="form" onsubmit="return validateForm();" method="post">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input value="<?php echo $data['gender']?>"  class="form-control" type="text" readonly><span id="ierror"></span></div>
                </div>
