...
<br><br>
        ...
        <h1 style="color:black;" class="text-center">shipping Information(s)</h1>
        <br>
    </div>
...
//AND date_format(parcel.time,'%Y-%m-%d')=date_format(sysdate(),'%Y-%m-%d')
              ...
              <a style="color:white;"  class="button button-reversed"  href="AdminView.php">Back</button></th>
                      ...
                      <th style="font-size: 18px;">Parcel No.</th>
                        <th style="font-size: 18px;">Parcel Image</th>
                       
                        
                       
                        <th style="font-size: 18px;">customer Surname</th>
                        <th style="font-size: 18px;">customer Name</th>
                        <th style="font-size: 18px;">customer Phone</th>
                        

                        
                        <th style="font-size: 18px;">Parcel Name</th>
                        <th style="font-size: 18px;">Parcel description</th>
                        <th style="font-size: 18px;">Parcel Weight</th>
                        
                        <th style="font-size: 18px;">Pick Up Location</th>
                        <th style="font-size: 18px;">Destination Address</th>
                       
                        <th style="font-size: 18px;">shipper Surname</th>
                        <th style="font-size: 18px;">shipper Name</th>
                        <th style="font-size: 18px;">shipper Phone</th>
